    ...
    <section className="py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        <div className="max-w-5xl">
          ...
          <h1 className="mt-6 max-w-4xl text-[2.9rem] font-medium tracking-[-0.03em] text-ink sm:text-[3.5rem] md:text-7xl lg:text-[5.25rem]">
          ...
          <p className="mt-8 max-w-2xl text-base leading-relaxed text-muted md:text-base">{hero.subtitle}</p>
